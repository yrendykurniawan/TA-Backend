...
class NGram:
    def __init__(self, tagNumbers={}, numberTags={}, uniGramFreqs={}, biGramFreqs={}, triGramFreqs={},
                 quatoGramFreqs={}):
...
def readNGrams(reader):
    ...
    for line in reader.readlines():
        ...
        if lplen == 2:
            ...
            quatoGramFreqs[QuatoGram(tagNumbers[lineParts[0]], tagNumbers[lineParts[1]], tagNumbers[lineParts[2]],
                                     tagNumbers[lineParts[3]])] = freq
...
class QuatoGram:
    ...
    def __eq__(self, other):
        ...
        # QuatoGram
        return (
        self.tag1 == other.tag1 and self.tag2 == other.tag2 and self.tag3 == other.tag3 and self.tag4 == other.tag4)
...
class Smoother:
    ...
    def quatoGramProbSucceed(self, quatoGram):
        ...
        prob = 1.0E-8
        if N != 0:
            prob = float(X + self.BigramLambda) / float(N + (self.BigramLambda * B))
        return math.log(prob)
